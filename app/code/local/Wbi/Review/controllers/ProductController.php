 ...
 */
class Wbi_Review_ProductController extends Mage_Core_Controller_Front_Action
{
    ...
    public function wbipostAction()
    {
        ...
        $cutomer = Mage::getModel("customer/customer")->load(Mage::getSingleton('customer/session')->getCustomerId());
        $data["nickname"] = $cutomer->getName(); 
        $data["title"] = "vote ".array_shift(array_values($rating));
        $data["detail"] = "vote ".array_shift(array_values($rating));
